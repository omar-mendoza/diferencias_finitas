...
/**
 * Ejemplo de la tesis de doctorado de Antonio Carrillo
 * Página 89
 *
 * -v \laplace u + b \grad u + cu = 0
 *  (x,y) in [-1,1]x[-1,1]
 *
 *  v = 0.01
 *  b = (y,-x)
 *  c = 10e-4
 *
 *  -0.01 u_xx -0.01 u_yy + y u_x - x u_y + 10e-4 u = 0
 */
...
int main(int argc, const char *argv[]) {
    ...
    // Definimos las coordenadas de los nodos y si son frontera
